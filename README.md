...
A cross-platform Linux desktop version is available in [`Linux/`](Linux/README.md). It preserves the original Windows WPF project and provides an Omarchy install script.
